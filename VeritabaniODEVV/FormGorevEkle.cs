...
namespace VeritabaniODEVV
{
    ...
    {
        GorevPanel panel;
        public FormGorevEkle(GorevPanel _panel)
        {
            panel = _panel;
            InitializeComponent();
        }
        ...
        private void FormGorevEkle_FormClosing(object sender, FormClosingEventArgs e)
        {
            panel.Show();
            panel.TabloYenile();
        }
        ...
        {
            baglanti.Open();
            NpgsqlCommand komut1 = new NpgsqlCommand($"insert into public.\"Tasks\" (\"PersonelID\",\"Title\",\"Description\") values(@p1,@p2,@p3)", baglanti);
